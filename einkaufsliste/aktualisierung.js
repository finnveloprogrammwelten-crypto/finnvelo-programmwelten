...
(function () {
  ...
  // Die Seite liegt unter /einkaufsliste ohne Schrägstrich. Der Bereich muss
  // das mit abdecken, sonst übernimmt der Dienstarbeiter die Seite nie.
  var GELTUNG = "/einkaufsliste";
  ...
  // Der weite Bereich braucht die Kopfzeile Service-Worker-Allowed. Fehlt sie,
  // wird auf den Standardbereich zurückgefallen – dann greift der Dienstarbeiter
  // wenigstens unter /einkaufsliste/… , nur nicht auf der Seite ohne Schrägstrich.
  function anmelden() {
    return navigator.serviceWorker.register("sw.js", { scope: GELTUNG })
      .catch(function () { return navigator.serviceWorker.register("sw.js"); });
  }

  window.addEventListener("load", function () {
    anmelden().then(function (anmeldung) {
